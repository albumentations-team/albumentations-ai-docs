...
3. Соотносите силу аугментации с ёмкостью модели: бо́льшие модели нуждаются в более сильной аугментации и могут её выдержать.
4. Оставляйте только то, что улучшает метрики, которые вам реально важны — измеренные по классам и по срезам.
5. Версионируйте и пересматривайте аугментационный пайплайн по мере изменения данных, моделей и условий деплоя.
